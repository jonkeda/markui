...
function buildBoxNode(
  ...
  let nodeType: WidgetType;
  switch (box.cornerChar) {
    case 'v': nodeType = 'VerticalList'; break;
    case '>': nodeType = 'HorizontalList'; break;
    case 'w': nodeType = 'WrappedList'; break;
    default:  nodeType = 'Box'; break;
  }
